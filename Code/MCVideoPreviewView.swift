...
@IBDesignable class MCVideoPreviewView : UIView
{
  ...
  {
    set { (self.layer as! AVCaptureVideoPreviewLayer).session = newValue }
    get { return (self.layer as! AVCaptureVideoPreviewLayer).session }
  }
}
